...
import { IoWarningOutline, IoHeartOutline, IoBusinessOutline, IoCubeOutline } from "react-icons/io5"
                ...
                <main className="lg:max-w-[1750px] mx-24  mt-10">
                    ...
                    <div className="flex gap-8">
                        <div className="lg:max-w-[1120px] rounded-lg shadow-lg mt-8 bg-white p-4 ">
                            <span className="block">Publicado ayer</span>
                            ...
                            <div className="border my-5 border-gray-300 flex-1" />
